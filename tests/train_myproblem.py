...
def main():
    ...
    pso = optimizer.MOPSO(objective=objective, lower_bounds=lb, upper_bounds=ub,
                        ...
                        rl_model=None, topology='round_robin', radius_scaler=0.010)
    ...
    env_kwargs = {'pso' : pso,
                ...
                'evaluation_penalty' : -3, #-300/num_iterations,
    ...
    pre_trained = None
    pre_trained = "./models/final_model/myproblem_pretrain_ag_50_iter_100_mr_2_mdr_0_p_-3_ndr_0_steps_500000_model"
    # train(env_fn, steps=steps, seed=0, name = name, pre_trained_model=pre_trained, **env_kwargs)

    #TEST

    rl_model = f"./{name}_model"
    explainability(pre_trained, [10,50])
