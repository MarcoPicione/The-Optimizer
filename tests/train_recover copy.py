...
def objective2(x):
    return np.cos(x[0]-2)*np.sin(x[1])*x[2]*x[1]*(x[0]-2)
...
def main():
    ...
    recover = PPO.load("./models/myproblem_pretrain_ag_50_iter_100_mr_1_mdr_0_p_-1_ndr_0_steps_200000/myproblem_pretrain_ag_50_iter_100_mr_1_mdr_0_p_-1_ndr_0_steps_200000_model")
    # pre_trained = None
    ...
    results = test_model(objective, mopso_parameters, num_iterations, rl_model, ref_point, seeds, path, plot_paretos_enabled = False, models_to_test = models_to_test, verbose = 2)
